...
public class DayController {
    ...
    private void initData() {
        ...
        lessonList2.add(new Lesson("География", "08:45", "09:30", 4, "145",  "Демченко А.С.", "прочитать параграф \"Дальний Восток\""));
        lessonList2.add(new Lesson("География", "09:50", "10:35", 0, "145", "Демченко А.С.", ""));
